...
@class iTunesPrintSettings, iTunesApplication, iTunesItem, iTunesAirPlayDevice, iTunesArtwork, iTunesEncoder, iTunesEQPreset, iTunesPlaylist, iTunesAudioCDPlaylist, iTunesLibraryPlaylist, iTunesRadioTunerPlaylist, iTunesSource, playingTrack, iTunesAudioCDTrack, iTunesFileTrack, iTunesSharedTrack, iTunesURLTrack, iTunesUserPlaylist, iTunesFolderPlaylist, iTunesVisual, iTunesWindow, iTunesBrowserWindow, iTunesEQWindow, iTunesPlaylistWindow;
...
@property (copy, readonly) playingTrack *currentTrack;  // the current targeted track
...
- (playingTrack *) add:(NSArray *)x to:(SBObject *)to;  // add one or more files to a playlist
- (void) backTrack;  // reposition to beginning of current track or go to previous track if already at start of current track
- (playingTrack *) convert:(NSArray *)x;  // convert one or more files or tracks
...
- (playingTrack *) searchFor:(NSString *)for_ only:(iTunesESrA)only;  // search a playlist for tracks matching the search string. Identical to entering search text in the Search field in iTunes.
...
@interface playingTrack : iTunesItem
...
@interface iTunesAudioCDTrack : playingTrack
...
@interface iTunesFileTrack : playingTrack
...
@interface iTunesSharedTrack : playingTrack


@end

// a track representing a network stream
@interface iTunesURLTrack : playingTrack
